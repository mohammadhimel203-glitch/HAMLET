...
export default function AdminWithdrawalsPage() {
  ...
  return (
    <div className="space-y-6">
      <Helmet><title>Manage Withdrawals | Admin</title></Helmet>
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Withdrawal Requests</h1>
        <p className="text-muted-foreground mt-1">Review and process brand owner profit payouts.</p>
      </div>
          ...
          <Table>
            ...
            <TableBody>
              {loading ? (
                ...
                <TableRow><TableCell colSpan={6} className="text-center py-8">No withdrawals found.</TableCell></TableRow>
              ) : (
                txs.map((t) => (
                  <TableRow key={t.id}>
                    ...
                    <TableCell className="font-bold text-red-600">{formatBDT(t.amount)}</TableCell>
                    <TableCell className="capitalize font-medium">{t.paymentMethod}</TableCell>
                    <TableCell>
